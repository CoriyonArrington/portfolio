...
function openMenu() {
    ...
    contactMe.style.gridRowStart = "3";
    contactMe.style.gridColumn = "span 2 / 3";
...
// this allows the mobile menu anchor links to navigate properly and closes the mobile menu
function anchorLink () {
    mainNav.style.transition = "0.4s ease-out";
    mainNav.style.height = "80px";
    mainNav.removeChild(contactMe);
